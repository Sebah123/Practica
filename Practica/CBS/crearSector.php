...
<body>
    ...
    <div class="container">
        <div class="row">
            <h5 class="left-align">Crear Sector</h5>
        </div>
        <form action="../CBS/crearSector_DO.php" method="POST" id="formulario">

            <label>Nombre Sector: </label> <br>
            <input type="text" name="txtSector" id="txtSector" maxlength="14"> <br> 
            <input type="reset" class='waves-effect blue darken-4 btn-small' value="Borrar">
            <input type="submit"  class='waves-effect blue darken-4 btn-small' value="Crear Sector"> 
