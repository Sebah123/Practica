...
<body>
            ...
            <nav class="grey darken-4">
                <div class="container">
                    <div class="nav-wrapper">
                        <a href="gestionCompletaU.php" class="brand-logo">Volver al Menú</a>
                        <ul id="nav-mobile " class="right hide-on-med-and-dow">
                            ...
                            <li><a href="UPSDHU.php">Ver UPS deshabilitados</a></li>
    ...
    <div class="container">
        <a href="crearUPS.php" class="waves-effect blue darken-4 btn-large">Crear UPS</a> <br> <br>
                    ...
                    if (isset($_GET['btnBuscar'])) {
                        ...
                        foreach ($lista as $fila) {
                            if ($fila["estado"] == 1) {
                                ...
                                echo "<td> 
                                        <a href='delete_do_upsU.php?id=" . $fila["id"] . "' class='waves-effect red accent-4 btn-small'><i class='tiny material-icons'>delete</i></a>
                                        <a href='editUPSU.php?id=" . $fila["id"] . "' class='waves-effect blue darken-4 btn-small'><i class='tiny material-icons'>edit</i></a>
                                    </td>";
                                echo "</tr>";
                            }
                        }
