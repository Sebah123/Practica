...
<body>
                ...
                <div class="container">
                    <div class="nav-wrapper">
                        ...
                        <ul id="nav-mobile " class="right hide-on-med-and-dow">
                            ...
                            <li><a href="telefonoDHU.php">Ver Telefonos deshabilitados</a></li>
    ...
    <div class="container">
        <a href="crearTelefono.php" class="waves-effect blue darken-4 btn-large">Crear Telefono</a> <br> <br>
                        ...
                        if (isset($_GET['btnBuscar'])) {
                            ...
                            foreach ($lista as $fila) {
                                if ($fila["estado"] == 1) {
                                    ...
                                    echo "<td> 
                                <a href='delete_DO_TelefonoU.php?id=" . $fila["id"] . "' class='waves-effect red accent-4 btn-small'><i class='tiny material-icons'>delete</i></a>
                                <a href='editFonoU.php?id=" . $fila["id"] . "' class='waves-effect blue darken-4 btn-small'><i class='tiny material-icons'>edit</i></a>
                            </td>";
                                    echo "</tr>";
                                }
                            }
