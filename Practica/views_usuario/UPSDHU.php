        ...
        <header>
            <div class="row">
                <nav class="grey darken-4">
                    <div class="container">
                        <a href="../views_usuario/index.php" class="brand-logo">Volver al Menú</a>
                        <ul id="nav-mobile" class="right hide-on-med-and-down">
                            <li><a href="../views_usuario/gestionUPSU.php">Volver</a></li>
                        </ul>
                    </div>
                    <!--<div class="container">
                ...
                <div class="col 8">
                    <table border="1">
                        ...
                        foreach ($lista as $fila) {
                                ...
                                echo "<td>
                            <a href='habilitarUPSU.php?id=" . $fila["id"] . "' class='waves-effect red accent-4 btn-small'>Habilitar</a>
                            </td>";
                                echo "</tr>";
                            }
