                    ...
                    if (isset($_GET['btnBuscar'])) {
                        ...
                        foreach ($lista as $fila) {
                            if ($fila["estadoActual"] == 1) {
                                ...
                                echo "<td>
                                <a href='../val/delete_DO_PC.php?id=" . $fila["id"] . "' class='waves-effect red accent-4 btn-small'><i class=' tiny material-icons'>delete</i></a>
                                <a href='editPC.php?id=" . $fila["id"] . "'class='waves-effect blue darken-4 btn-small'><i class='tiny material-icons'>edit</i></a>
                                </td>";
                                echo "</tr>";
                            }
                        }
