...
<body>
                ...
                <div class="container">
                    <div class="nav-wrapper">
                        ...
                        <ul id="nav-mobile " class="right hide-on-med-and-dow">
                            ...
                            <li><a href="../views/gestionComputador.php">Atrás</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
    ...
    <div class="container">
        ...
        <form action="../val/create_DO_PC.php" method="POST" id="formulario">
            ...
            <input type="text" name="txtNumSerie" id="txtNumSerie" maxlength="15"> <br>
