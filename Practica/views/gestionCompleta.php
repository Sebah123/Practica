...
<body>
                ...
                <div class="container">
                    <div class="nav-wrapper">
                        ...
                        <ul id="nav-mobile " class="right hide-on-med-and-dow">
                            ...
                            <!--<li><a href="../views/index.php">Gestionar Usuarios</a></li>-->
                        </ul>
                    </div>
                </div>
            </nav>
    ...
    <div class="container">
        <a href="../views/gestionComputador.php" class="waves-effect blue darken-4 btn-large">Gestionar Computadores</a> <br> <br>
        <a href="../views/gestionUPS.php" class="waves-effect blue darken-4 btn-large">Gestionar UPS</a> <br> <br>
        <a href="../views/gestionTelefono.php" class="waves-effect blue darken-4 btn-large">Gestionar Telefono</a> <br> <br>
    </div>
