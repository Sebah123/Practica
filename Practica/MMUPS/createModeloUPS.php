...
<body>
                ...
                <div class="container">
                    <div class="nav-wrapper">
                        ...
                        <ul id="nav-mobile " class="right hide-on-med-and-dow">
                            ...
                            <li><a href="../views/create_UPS.php">Atrás</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
    ...
    <div class="container">
        <div class="row">
            <h5 class="left-align">Crear Modelo UPS</h5>
        </div>
        <form action="../MMUPS/createModeloUPS_DO.php" method="POST" id="formulario">
