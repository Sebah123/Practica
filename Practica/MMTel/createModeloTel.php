...
<head>
    ...
    <title>Crear Modelo Telefono</title>
</head>
...
<body>
                ...
                <div class="container">
                    <div class="nav-wrapper">
                        ...
                        <ul id="nav-mobile " class="right hide-on-med-and-dow">
                            ...
                            <li><a href="../views/create_telefono.php">Atrás</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
    ...
    <div class="container">
        <div class="row">
            <h5 class="left-align">Crear Modelo Telefono</h5>
        </div>
        <form action="../MMTel/createModeloTel_DO.php" method="POST" id="formulario">

            <label>Modelo: </label> <br>
            <input type="text" name="txtModelo" id="txtModelo" maxlength="16"> <br> 

            <label>Marca Asociada: </label><br>

            <select name="selMarca" id="selMarca" class="browser-default">
                <?php 
                $hola = $data->getMarcaTelefono();
                foreach($hola as $fila){
